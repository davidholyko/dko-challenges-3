...
const mapping = objects => {
  // TODO: return an array of just the aliases of the programmers
}

const sorting = objects => {
  // TODO: return an array of the programmers sorted
  // by most experience first and alias alphabetically second
}

const filtering = objects => {
  // TODO: return an array of the programmers who are in Boston
}

const reducing = objects => {
  // TODO: return an array with the keys of all languages
