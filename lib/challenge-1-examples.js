...
const total = inputObject => {
  ...
  // one line answer:
  // return Object.values(teams).reduce((a, b) => a + b)
...
// in the terminal run
// node lib/challenge-1-examples.js
// from this folder's root to see console logs

console.log(total(teams))
console.log(findValue(teams, 'patriots'))
console.log(increaseValue(teams, 'titans'))
console.log(replaceValue(teams, 'eagles', 100000))
